...
void bot_body(int move)
{
    ...
    switch(move) 
	{
    	case 0: left = 0;	right=90; break;
        case 1: left = 15; right=75; break;
        case 2: left = 30;right=60; break;
        case 3: left = 45;right=45; break;
        case 4: left = 60;right=30; break;
        case 5: left = 75;right=15;  break;
        case 6: left = 90;right=0;  break;  
    }
	char before[left+1];
	char after[right+1];
	for ( i = 0; i < left-1; i++)
